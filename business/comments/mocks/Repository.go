...
// GetAllInThread provides a mock function with given fields: ctx, threadId, parentId, option
func (_m *Repository) GetAllInThread(ctx context.Context, threadId string, parentId string, option string) ([]comments.Domain, error) {
	ret := _m.Called(ctx, threadId, parentId, option)

	var r0 []comments.Domain
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string) []comments.Domain); ok {
		r0 = rf(ctx, threadId, parentId, option)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]comments.Domain)
		}
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, string, string) error); ok {
		r1 = rf(ctx, threadId, parentId, option)
	} else {
		r1 = ret.Error(1)
	}
