...
func (_m *UseCase) Create(ctx context.Context, data *categories.Domain) (categories.Domain, error) {
...
func (_m *UseCase) Update(ctx context.Context, data *categories.Domain, id string) error {
