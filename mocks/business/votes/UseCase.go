...
func (_m *UseCase) GetIsVoted(ctx context.Context, username string, refId string) (votes.Domain, error) {
...
func (_m *UseCase) Store(ctx context.Context, data *votes.Domain, id string) error {
...
func (_m *UseCase) Update(ctx context.Context, status int, id string, refid string) error {
